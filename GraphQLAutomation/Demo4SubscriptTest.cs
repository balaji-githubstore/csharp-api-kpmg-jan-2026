...
{
    public class Demo4SubscriptTest
    {
        ...
        public async Task InsertMutationTodosTestAsync()
        {
            ...
            var body = new
            {
                query = @"
                    ...
                    mutation {
                      insert_todos(objects: {title: ""Demo999""}) {
                        affected_rows
                      }
                    }"
            };
        ...
        [Test]
        public async Task SubscriptionTestAsync()
        {
            var client = new RestClient(baseUrl: "https://hasura.io/learn/graphql");
            var request = new RestRequest("", Method.Post);
            request.AddHeader("Content-Type", "application/json");
            ...
            await InsertMutationTodosTestAsync();
            ...
            Console.WriteLine(jsonResponse["data"]["todos"]);
        }
    }
}
